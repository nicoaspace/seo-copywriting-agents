...
# ──────────────────────────────────────────────────────────────────────────────
# Flowchart component declaration
# ──────────────────────────────────────────────────────────────────────────────
import streamlit.components.v1 as components
_parent_dir = Path(__file__).resolve().parent
flowchart_component = components.declare_component(
    "flowchart_component",
    path=str(_parent_dir / "flowchart_component")
)
...
def _show_landing_page() -> None:
    ...
    flowchart_component(key="landing_flowchart")
